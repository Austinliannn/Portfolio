...
export default function Home(){
    return(
        <>
            ...
            <Container id="intro" className={(isMobile) ? "pb-0" : "pb-4"}>
                <Row className="d-flex justify-content-center py-2">
                    ...
                    >
                        <img 
                            ...
                            src={header_pic}
                            style= {(isMobile) ? {width: "52%", borderRadius: "30px"} : {width: "76%", borderRadius: "40px"}}
                        />
                    </Col>
                    ...
                    >
                        ...
                        <Row>
                            ...
                            >
                                ...
                                I have worked on numerous projects to <b style={{color: "#00ADB5"}}>elevate my skills</b> as a developer.
            ...
            <Container id="works" className={(isMobile) ? "py-0" : "py-5"}>
                <Row>
                    <Col 
                        xs={12} md={12} lg={12} xl={12} xxl={12} 
                        className="d-flex justify-content-center pt-3 animate__animated animate__fadeInDown"
                    >
                        <h1><u>Selected Works</u></h1>
                    </Col>
                </Row>
            ...
            <Container id="contact" className={(isMobile) ? "py-0" : "py-5"}>
                <Row>
                    <Col 
                        xs={12} md={6} lg={6} xl={6} xxl={6} 
                        className="d-flex justify-content-center pt-3 animate__animated animate__fadeInDown"
                    >
                        <h1><u>Lets work together</u></h1>
                    </Col>
                </Row>
            </Container>
        </>
