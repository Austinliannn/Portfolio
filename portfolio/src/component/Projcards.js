    ...
    <>
        {
            props.data.map((entry, index) => (
                <Col key={index} xs={12} md={12} lg={4} xl={4} xxl={4} className="py-3">
                    <Card className="animate__animated animate__fadeInLeft" style={{minHeight: "23rem"}}>
                        ...
                        <Card.Body className="pt-0 py-0 ">
                            ...
                            <Card.Text className="d-flex justify-content-left align-items-center p-0" style={{fontSize: "1.2em"}}>
                                <a href={entry.read} target= "_blank" className="d-flex justify-content-end" style={{color: "#222831"}}>
                                    <BsIcons.BsArrowRightCircleFill/> 
                                </a>
                                &nbsp; &nbsp; 
                                <a href={entry.github} target= "_blank" className="d-flex justify-content-end" style={{color: "#222831"}}>
                                    <BsIcons.BsGithub/> 
                                </a>
                            </Card.Text>
                        </Card.Body>
