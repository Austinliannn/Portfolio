          ...
          <Col xs={10} md={6} lg={6} xl={6} xxl={6} className="py-3 pb-4">
            <Row>
              <h1 className="pl-1 pt-3 animate__animated animate__fadeInDown">
                ...
                <br />
                <b style={{ color: "#00ADB5" }}>Developer</b> based in
                Singapore.
                <br />
              </h1>

              <span className="p-0 animate__animated animate__fadeInDown">
                <b style={{ fontSize: "0.8em", opacity: "0.3" }}>
                  Year 3 Computer Science undergraduate at University of London
                </b>
                <br />
                <br />
              </span>
            ...
            <Row>
              ...
              >
                ...
                employer <b style={{ color: "#00ADB5" }}>onboard clients</b>{" "}
                during sales. I believe that I am able to help companies reach
                their{" "}
                <b style={{ color: "#00ADB5" }}>
                  fullest potential and attract new customers
                </b>
                .
              </span>
            </Row>
            ...
            <Row>
              <span className="p-0 pb-3 animate__animated animate__fadeInDown">
                <br />
                <Link style={{ color: "#00ADB5" }} to={"/projects"}>
                  View My Projects
                </Link>
                &nbsp; &nbsp; or &nbsp; &nbsp;
                <Link style={{ color: "#00ADB5" }} to={"/aboutme"}>
                  Read About Me
                </Link>
              </span>
            </Row>
