        ...
        <Row className="d-flex justify-content-center">
          ...
          <Row className="pt-3">
            ...
            >
              <Row>
                <span style={{ width: "90%" }}>
                  ...
                  <b style={{ color: "#00ADB5" }}>quicker and more efficient</b>{" "}
                  process when it comes to finding remote workspaces for working
                  adults, bridging the gap of manually going through various
                  online articles and blogs to a few simple steps.
                  <br />
                  <br />
                  “WorkGoWhere” specifically narrow down remote work spaces that
                  meet the needs of users, it can{" "}
                  <b style={{ color: "#00ADB5" }}>
                    significantly improve the ease and efficiency
                  </b>{" "}
                  of finding such places at different places and times.
                </span>
              </Row>
              ...
              >
                Skills: JavaScript, HTML, CSS, Tailwind CSS, MongoDB, ExpressJS,
                ReactJS, NodeJS <br /> <br />
                Tools: Visual Studios Code, Figma, Jira, Discord, Github <br />{" "}
                <br />
              ...
              >
                ...
                &nbsp; &nbsp;
                <a
                  href="https://github.com/AgileProjectY2"
                  target="_blank"
                  rel="noreferrer"
                  className="d-flex justify-content-end"
                  style={{ color: "#222831" }}
            ...
            <Col
              ...
              xl={6}
              xxl={6}
              className="animate__animated animate__fadeInRight pt-2"
            >
              <video
                width="100%"
                controls
        ...
        <Row className="pt-4">
          ...
          >
            <Row className="pb-1">
              ...
              <br />
              <span className="p-0">
                - This phase consist of project ideation and{" "}
                <b style={{ color: "#00ADB5" }}>mapping of aims/objectives</b>.{" "}
              </span>
            </Row>

            <Row className="pb-1">
              <h5>
                <u>Research & Requirements Gathering</u>
              </h5>{" "}
              <br />
              <span className="p-0">
                - This phase consist of project research process,{" "}
                <b style={{ color: "#00ADB5" }}>analysis</b> and{" "}
                <b style={{ color: "#00ADB5" }}>specifications</b>.{" "}
              </span>
            </Row>
            ...
            <Row className="pb-1">
              ...
              <br />
              <span className="p-0">
                - This phase consist of project design such as{" "}
                <b style={{ color: "#00ADB5" }}>low-high fidelity</b> and{" "}
                <b style={{ color: "#00ADB5" }}>mock-ups</b>.{" "}
              </span>
            </Row>
            ...
            <Row className="pb-1">
              ...
              <br />
              <span className="p-0">
                - This phase consist of project{" "}
                <b style={{ color: "#00ADB5" }}>front-end development</b> with{" "}
                <b style={{ color: "#00ADB5" }}>ReactJS</b>.{" "}
              </span>
            </Row>
            ...
            <Row className="pb-1">
              ...
              <span className="p-0">
                - This phase consist of project{" "}
                <b style={{ color: "#00ADB5" }}>back-end development</b> with{" "}
                <b style={{ color: "#00ADB5" }}>MERN stack</b>.{" "}
              </span>
            </Row>
            ...
            <Row className="pb-1">
              ...
              <span className="p-0">
                ...
                <b style={{ color: "#00ADB5" }}>code refactoring</b> and{" "}
                <b style={{ color: "#00ADB5" }}>
            ...
            <Row>
              ...
              <span className="p-0">
                - This phase consist of project{" "}
                <b style={{ color: "#00ADB5" }}>report</b> and{" "}
                <b style={{ color: "#00ADB5" }}>review</b>.{" "}
              </span>
            </Row>
          </Col>
          ...
          <Col xs={12} md={12} lg={4} xl={4} xxl={4} className="p-0">
            <Row>
              <Col
                ...
                xl={12}
                xxl={12}
                className="d-flex justify-content-center animate__animated animate__fadeInDown py-3"
              >
                <u>Low-Fidelity</u>
              </Col>
            </Row>
        ...
        <Row>
          <Row>
            <h3 className="d-flex justify-content-center animate__animated animate__fadeInDown">
              <u>Customers finding a space & Owners listing a space</u>
            </h3>
          </Row>
