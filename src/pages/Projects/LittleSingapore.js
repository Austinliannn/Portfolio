        ...
        <>
            <Container id="intro" className="pb-5">
                <Row className="d-flex justify-content-center">
                    ...
                    <Row className="pt-3">
                        <Col xs={12} md={12} lg={6} xl={6} xxl={6} className="animate__animated animate__fadeInLeft py-4">
                            <Row>
                                <span style={{width: "90%"}}>
                                    The project aims to <b style={{color: "#00ADB5"}}>attract new customers</b> by <b style={{color: "#00ADB5"}}>displaying information</b> about thrilling rides and facilities for a newly built theme-park. 
                                    Apart from thrilling rides, customers are able to <b style={{color: "#00ADB5"}}>efficiently</b> plan their itinerary around the park and transportation to the park.
                                    Furthermore, tickets and merchandise are sold on the website so that customers can <b style={{color: "#00ADB5"}}>purchase items with ease</b>.
                                </span>
                            </Row>
                            ...
                            <span className="d-flex justify-content-end" style={{fontSize: "1.4em", color: "#393E46"}}>
                                <a href="https://github.com/WebDevGroup101" target= "_blank" rel="noreferrer" className="d-flex justify-content-end" style={{color: "#222831"}}>
                                    <BsIcons.BsGithub/> 
                                </a>
                            </span>
                        </Col>

                        <Col xs={12} md={12} lg={6} xl={6} xxl={6} className="animate__animated animate__fadeInRight py-4">
            ...
            <Container id="research" className="py-4">
                ...
                <Row className="pt-4">
                    ...
                    <Col xs={11} md={11} lg={6} xl={6} xxl={6} className="animate__animated animate__fadeInRight">
                        <Row className="pb-3">
                            <h5><u>Competitors</u></h5> <br/>
                            <span className="p-0">- Competitors research consist of mindmaps drawn to compare this project with other theme-parks.</span>
                        </Row>

                        <Row className="pb-3">
                            <h5><u>Consideration factors</u></h5> <br/>
                            <span className="p-0">- Positive aspects of the website as well as the features implemented.</span>
                            <span className="p-0">- Negative aspects of the website as well as features to be improved.</span>
                        </Row>

                        <Row className="pb-3">
                            <h5><u>Requirements</u></h5> <br/>
                            <span className="p-0">- List requirements of the website such as services and information included.</span>
                        </Row>

                        <Row className="pb-3">
                            <h5><u>Designing</u></h5> <br/>
                            <span className="p-0">- Project design consist of wireframes and mock-ups. </span>
                        </Row>

                        <Row>
                            <h5><u>Deliverables</u></h5> <br/>
                            <span className="p-0">- Final version of the website with requirements achieved.</span>
                        </Row>
                    </Col>
            ...
            <Container id="wireframes" className="py-4">
                ...
                <Row>
                    <Col xs={12} md={12} lg={6} xl={6} xxl={6} className="p-0">
                        <Row>
                            <Col xs={12} md={12} lg={12} xl={12} xxl={12} className="d-flex justify-content-center animate__animated animate__fadeInDown py-1">
                                <u>Desktop View</u>
                            </Col>
                        </Row>
                        ...
                        <Row style={{minHeight: "23rem"}}>
                            <Col xs={12} md={12} lg={12} xl={12} xxl={12} className="d-flex justify-content-center animate__animated animate__fadeInLeft">
                                <img 
                                    src={DesktopWF}
                                    style= {{borderRadius: "10px", width: "80%", border: "solid 2px grey"}}
                                />
                            </Col>
                        </Row>
                    </Col>
                    ...
                    <Col xs={12} md={12} lg={6} xl={6} xxl={6} className="p-0">
                        ...
                        <Row style={{minHeight: "23rem"}}>
                            <Col xs={12} md={12} lg={12} xl={12} xxl={12} className="d-flex justify-content-center animate__animated animate__fadeInLeft">
                                <img 
                                    src={MobileWF}
                                    style= {{borderRadius: "10px", width: "68%", border: "solid 2px grey"}}
                                />
                            </Col>
                        </Row>
                    </Col>

                    <a href="#deliverables" className="d-flex justify-content-center pt-3">
                        <FiIcons.FiChevronsDown className="animate__animated animate__bounce" style= {{opacity: "0.5", fontSize: "20px", color: "#222831"}}/>
                    </a>
                </Row>
            </Container>
            ...
            <Container id="deliverables" className="py-3">
                <Row>
                    <Row>
                        <h3 className="d-flex justify-content-center animate__animated animate__fadeInDown"><u>Theme-park web application</u></h3> 
                    </Row>

                    <Row className="pt-2">
                        <Col xs={12} md={12} lg={6} xl={6} xxl={6} className="d-flex justify-content-center animate__animated animate__fadeInRight py-2">
                            <img 
                                src={FrontPage}
                                style= {{borderRadius: "10px", width: "82%", border: "solid 2px grey"}}
                            />
                        </Col>
